 ...
 */
package com.mycompany.comunicacionformulario6;
...
public class Formulario2 extends javax.swing.JFrame {
    ...
    public Formulario2(String Nombre, int Edad) {
        initComponents();
        jlblNombre.setText(Nombre);
        jlblEdad.setText(String.valueOf(Edad));
    }
